...
public class SingleInfileObjectLoader<E> extends InfileObjectLoader<E> {
    ...
    protected final Map<Class<?>, AttributeConverter<?, ?>> attributeConverters = newHashMap();
        ...
        if (entity == null && allowNull) {
            ...
            for (Method m : mappings.values()) {
                ...
                if (object != null) {
                    ...
                    AttributeConverter converter = attributeConverters.get(object.getClass());
                    if (converter != null) {
                        infileRow.append(converter.convertToDatabaseColumn(object));
                    }
    ...
    Object getEnumValueToAppend(Method method, Enum<?> enumObject) {
        AttributeConverter converter = attributeConverters.get(Enum.class);
        if (converter != null) {
            return converter.convertToDatabaseColumn(enumObject);
        }
